...
#define LOOP_TIME 98           // Time loop duration to achieve 1kHz output at 1kHz frequency
long currentFrequency = 1000;  // Initial frequency (valid up to ~10 kHz)

byte waveform[SAMPLES];        // Array to store waveform data
int WaveType = 0;              // Waveform types
const char* Waves[5] = { "Sine     ", "Triangle ", "Ramp Down", "Ramp Up  ", "Square   " };
